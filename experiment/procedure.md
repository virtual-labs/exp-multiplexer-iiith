...
1. Drag the NOT gate and connect its input point to the Select input bit.
2. Drag the first AND gate and connect its input points to the input bit A and the output point of the NOT gate.
3. Drag the second AND gate and connect its input points to the input bit B and the Select input bit.
4. Drag the OR gate and connect its input points to the output points of the two AND gates.
...
1. Drag the first 2X1 Multiplexer and connect its input points A and B to the input bits I<sub>0</sub> and I<sub>1</sub> respectively.
2. Connect its Select input point to the input bit S<sub>0</sub>.
3. Drag the second 2X1 Multiplexer and connect its input points A and B to the input bits I<sub>2</sub> and I<sub>3</sub> respectively.
4. Connect its Select input point to the input bit S<sub>0</sub>.
5. Drag the third 2X1 Multiplexer and connect its input points A and B to the output points of first and second Multiplexer respectively.
